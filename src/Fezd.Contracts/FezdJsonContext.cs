...
namespace Fezd.Contracts
{
    ...
    [JsonSerializable(typeof(ChunkedUploadInitRequestDto))]
    [JsonSerializable(typeof(ChunkedUploadInitResultDto))]
    [JsonSerializable(typeof(ChunkedUploadPartAckDto))]
    [JsonSerializable(typeof(ChunkedUploadStatusDto))]
    ...
    [JsonSerializable(typeof(AutomationProfileDto))]
    [JsonSerializable(typeof(AutomationPlatformDto))]
    [JsonSerializable(typeof(SimulatorProfileDto))]
    [JsonSerializable(typeof(PlatformsResponseDto))]
